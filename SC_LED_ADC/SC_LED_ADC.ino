...
void processSensorUpdate(String sensor, String value) {
  showMessage(sensor + " " + value, 0.5);

  if (sensor == "D2") {
    digitalWrite(2, value.toInt());
  }
}
